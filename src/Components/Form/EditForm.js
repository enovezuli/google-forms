...
EditForm.propTypes = {
  match: PropTypes.object.isRequired // Add propTypes for match
}
...
function EditForm (props) {
  ...
  React.useEffect(() => {
    setUser(auth.getCurrentUser())
    console.log('Current user:', auth.getCurrentUser()) // Add this line
    console.log('user.id:', auth.getCurrentUser().id) // Add this line
  ...
  return (
    <div>
      {formDetails.createdBy === user.id
            ...
            <div>
              ...
              >
                ...
                <DialogContent>
                  ...
                  {
                    /*
                    TODO: Possibly needs commenting
                    */
        ...
        : (
          <p>you&apos;re not the owner of the form [{formDetails.createdBy} {user.id}]</p>
        )}
    </div>
  )
}
