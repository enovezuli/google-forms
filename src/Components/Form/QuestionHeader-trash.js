              ...
              <div style={{ marginBottom: '9px' }}>
                ...
                <Accordion onChange={() => { handleExpand(i) }} expanded={questions[i].open}>
                  ...
                  <AccordionDetails>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'flex-start', flexDirection: 'column', alignItems: 'flex-start', marginLeft: '15px' }}>

                      <Typography variant='subtitle1'>Form description {i + 1}</Typography>

                      <div style={{ width: '100%', display: 'flex', alignItems: 'center' }}>
                        {ques.options.map((_, j) => (
                          <div key={j} style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>

                            <Radio disabled />
                            <TextField fullWidth placeholder='Option text' style={{ marginTop: '5px' }} />
