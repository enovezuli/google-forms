                  ...
                  >
                    {!questions[i].open ? (
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginLeft: '3px', paddingTop: '15px', paddingBottom: '15px' }}>
                        ...
                        {ques.questionImage !== '' ? (
                          <div>
                            <img src={ques.questionImage} width='400px' height='auto' alt='quesImage' /><br /><br />
                          </div>
                        ) : ''}
                        ...
                        {ques.options.map((op, j) => (
                          ...
                          <div key={j}>
                            <div style={{ display: 'flex' }}>
                              <FormControlLabel
                                disabled control={<Radio style={{ marginRight: '3px' }} />} label={
                            ...
                            <div>
                              {op.optionImage !== '' ? (
                                <img src={op.optionImage} width='160px' height='auto' alt='optionImage' />
                              ) : ''}
                            </div>
                          </div>
                        ))}
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', marginLeft: '15px', marginTop: '-15px' }}>
                      <div style={{ display: 'flex', width: '100%', justifyContent: 'space-between' }}>
                        ...
                        <TextField
                          ...
                          minRows={2}
                          maxRows={20}
                          multiline value={ques.questionText}
                          variant='filled'
                          ...
                          checkImageHereOrNotForQuestion(ques.questionImage) ? (
                            <div>
                              <div style={{ width: '150px', display: 'flex', alignItems: 'flex-start', paddingLeft: '20px' }}>
                                <img src={ques.questionImage} width='150px' height='auto' alt='quesImage' />
                                <IconButton
                            ...
                            <div>
                              {
                                checkImageHereOrNotForOption(op.optionImage) ? (
                                  <div>
                                    <div style={{ width: '150px', display: 'flex', alignItems: 'center', justifyContent: 'center', paddingLeft: '20px' }}>
                                      <img src={op.optionImage} width='90px' height='auto' alt='optionImage' />
                      ...
                      {ques.options.length < 5 ? (
                        <div>
                          <FormControlLabel
                            disabled control={<Radio />} label={
                              <Button size='small' onClick={() => { addOption(i) }} style={{ textTransform: 'none', marginLeft: '0px' }}>
                                Add Option
                              </Button>
                            }
                          />
